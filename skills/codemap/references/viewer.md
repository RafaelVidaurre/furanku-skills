...
| Arrow on Layers / Component | code importing code: thicker for more imports; faint dotted when only tests or build configuration import it and Tests is on; red dashed when Code quality marks are on and an open finding involves the import |
